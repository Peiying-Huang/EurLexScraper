...
2. Make a connected graph of the main link. The details are seen in the graph3_full_graph_Test.ipynb):\
...
The DocumentSumScraper extracts the data from the Document Summary page. There is a testing file to test the code (document_sum_scraper_Test.ipynb)\
   ...
   **Note: The code raises an error when the website doesn't exist. Some of the websites only contain parts of the sections, e.g., {'Title and reference': , 'Miscellaneous information': }.**.\
